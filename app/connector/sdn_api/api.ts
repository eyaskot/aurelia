...
export class HttpClient<SecurityDataType = unknown> {
  ...
  private contentFormatters: Record<ContentType, (input: any) => any> = {
    [ContentType.Json]: (input: any) =>
      input !== null && input instanceof hasuraSdk.JSONValue
...
/**
 * @title Aurelia SDN API
 * @version 1.0.0
 *
 * SDN Sanctions List API
 */
...
> extends HttpClient<SecurityDataType> {
  healthz = {
     ...
     * No description
     *
     * @name HealthzHealthzGet
     * @summary Healthz
     * @request GET:/healthz
     */
    healthzHealthzGet: ({ params = {} }: { params?: RequestParams }) =>
  ...
  getsdn = {
    ...
    getsdnGetsdnGet: ({
      ...
      this.request<SdnResponse, HTTPValidationError>({
        path: `/getsdn`,
        method: "GET",
        query: query,
        format: "json",
