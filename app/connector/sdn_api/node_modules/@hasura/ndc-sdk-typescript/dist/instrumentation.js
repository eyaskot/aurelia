...
const traceHttpProto = __importStar(require("@opentelemetry/exporter-trace-otlp-proto"));
const metricsHttpProto = __importStar(require("@opentelemetry/exporter-metrics-otlp-proto"));
const traceGrpc = __importStar(require("@opentelemetry/exporter-trace-otlp-grpc"));
const metricsGrpc = __importStar(require("@opentelemetry/exporter-metrics-otlp-grpc"));
...
let sdk = null;
function initTelemetry(defaultServiceName = "hasura-ndc", defaultEndpoint = "http://localhost:4317", defaultProtocol = "grpc") {
    if (isInitialized()) {
...
function getExporters(protocol, endpoint) {
    switch (protocol) {
        case "grpc":
            return {
