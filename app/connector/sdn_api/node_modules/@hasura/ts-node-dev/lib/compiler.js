...
var makeCompiler = function (options, _a) {
    ...
    var tsConfigPath = (0, tsconfig_1.resolveSync)(cwd, typeof project === 'string' ? project : undefined) || '';
    ...
    var writeChildHookFile = function (options) {
        ...
        var varDecl = function (name, value) { return "var ".concat(name, " = '").concat(value, "'"); };
        var replacements = [
    ...
    var init = function () {
        ...
        rimraf_1.rimraf.sync(getCompiledDir());
        createCompiledDir();
    ...
    var createCompiledDir = function () {
        ...
        if (!fs_1.default.existsSync(compiledDir)) {
            mkdirp_1.mkdirp.sync(getCompiledDir());
        }
    };
    ...
    var registerTsNode = function () {
        ...
        tsNode.register({
            ...
            dir: (0, get_cwd_1.getCwd)(options['dir'], options['script-mode'], scriptPath),
            scope: options['scope'],
        ...
        compileChanged: function (fileName) {
            ...
            try {
                ...
                compiler.compile({
                    code: code,
                    compile: fileName,
                    compiledPath: (0, get_compiled_path_1.getCompiledPath)(code, fileName, getCompiledDir()),
                });
            }
            catch (e) {
                console.error(e);
