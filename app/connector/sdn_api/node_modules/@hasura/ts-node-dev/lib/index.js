...
var runDev = function (script, scriptArgs, nodeArgs, opts) {
    ...
    // The child_process
    var child;
    var wrapper = (0, resolveMain_1.resolveMain)(__dirname + '/wrap.js');
    var main = (0, resolveMain_1.resolveMain)(script);
    var cfg = (0, cfg_1.makeCfg)(main, opts);
    var log = (0, log_1.makeLog)(cfg);
    var notify = (0, notify_1.makeNotify)(cfg, log);
    ...
    function start() {
        ...
        child = (0, child_process_1.fork)(cmd[0], cmd.slice(1), {
            cwd: process.cwd(),
            env: process.env,
        });
        starting = false;
    ...
    var compiler = (0, compiler_1.makeCompiler)(opts, {
        restart: restart,
        log: log,
    });
    compiler.init();
